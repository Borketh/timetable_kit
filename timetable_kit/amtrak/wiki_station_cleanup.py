...
This is not being used but is preserved in case it might come in handy later. It is
therefore full of hardcoded filenames, and probably subject to bitrot. It is better to
...
two_station_cities = [
    "Buffalo",  # There are *three* stations: Depew, unmarked, bus stop
...
suffixes = [
    "Alvarado Transportation Center",  # At ABQ
    "Amtrak Station",
    "Amtrak",
    "Amtrak Bus Stop",
    "Penn Station",
