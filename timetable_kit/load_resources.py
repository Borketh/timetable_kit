...
def get_icon_svg(filename: str) -> str:
    ...
    This uses Jinja2, icon_loader, and icon_environment. Technically this is the same
    code as get_icon_css right now.
    """
...
def get_logo_svg(filename: str) -> str:
    ...
    This uses Jinja2, logo_loader, and logo_environment. Technically this is the same
    code as get_logo_css right now.
    """
